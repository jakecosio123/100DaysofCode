...
if direction == "left":
    ...
    if swim_or_wait == "wait":
        door = input("After you land safely on the other side, you come to a building with a red, a yellow, and a blue door. Which color door do you choose?\n").lower()
        if door == "red":
            print("The door opens and fire shoots out, burning you alive. Game Over.")
        elif door == "blue":
            print("As you open the door, wild beasts stampede out and trample you. Game Over.")
        elif door == "yellow":
